...
<section>
	...
	<details>
		...
		<fieldset>
			...
			원본 테이터를 해시 처리하면 새로운 형태의 데이터가 나오는데<br>
			결과 데이터를 이용하여 다시 원본을 유츄할 수 없다는 특징이 있다<br>
			한번 해시처리된 데이터는 원본으로 되돌릴 수 없으나<br>
			원본이 동일하면 해시값도 동일하다는 특성이 있어서, 일치 비교에 사용 할 수 있다
			</p>
			<p>
			...
			주로 네트워크 상에서 송식측 메시지를 암호화하여 전송하고, 수신측에서 복호화하여 나타낸다
			</p>
		</fieldset>
	</details>
</section>
